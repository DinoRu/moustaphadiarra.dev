...
export default function OpenToWorkBadge() {
  return (
    <div className="static sm:absolute sm:mt-24">
      <Link href={'/resume'}>
        <div className="text-primary ml-0 inline-flex max-w-full items-center rounded-full border border-primary-500 bg-transparent px-2.5 py-0.5 text-xs font-semibold backdrop-blur-md transition-colors duration-150 hover:bg-primary-500 hover:text-white focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 sm:ml-0 md:ml-0">
          <div
